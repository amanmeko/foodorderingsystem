...
var myOptions = {
    zoom: 28,
    center: new google.maps.LatLng(8.564376, 39.289472),
    mapTypeId: 'roadmap'
};
...
var addMarker = google.maps.event.addListener(map, 'click', function(e) {
    ...
    var marker = new google.maps.Marker({
        ...
        html: "    <div id='info_" + markerId + "'>\n" +
            ...
            "            <tr><td></td><td><input type='button' value='Save' onclick='saveData(" + lat +
            "," + lng + ")'/></td></tr>\n" +
            "        </table>\n" +
            "    </div>"
    });
...
for (i = 0; i < locations.length; i++) {
    marker = new google.maps.Marker({
        ...
        html: "<div>\n" +
            ...
            "<tr>\n" +
            "<td><a>Description:</a></td>\n" +
            "<td><textarea disabled id='manual_description' placeholder='Description'>" + locations[i][3] +
            "</textarea></td></tr>\n" +
            "</table>\n" +
            "</div>"
    });
    ...
    downloadUrl(url, function(data, responseCode) {
        if (responseCode === 200 && data.length > 1) {
            ...
            infowindow.setContent(
                "<div style=' color: purple; font-size: 25px;'> Waiting for deliver here!!</div>");
