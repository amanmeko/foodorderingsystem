...
<body>
	...
	{
	?>
        <a class="navbar-brand" style="color:black; text-decoratio:none;">
            <i class="fa fa-user" aria-hidden="true"><?php echo $cresult['fld_name']; ?></i>
        </a>
        <?php
	}
	?>
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/coffee_foam_beverage_cup_saucer_creative_continents_84944_1920x1080 (1).jpg"
                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <div class="row" style="padding:10px; ">
                            ...
                            <div class="col-sm-3">Birr
                                &nbsp;<span style="color:green; font-size:25px;"><?php echo $res['cost']; ?></span>
                            </div>
                            <form method="post">
